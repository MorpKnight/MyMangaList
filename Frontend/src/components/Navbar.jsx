...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 w-full items-center flex justify-between flex-wrap p-3 bg-[#2B2D42] rounded-b-2xl z-50">
      ...
      >
        <ul className="text-sm lg:flex-grow">
          <li
            ...
            onClick={() => {
              setIsOpen(false);
              // Add the navigation to the search page if needed
            }}
          >
            Search
          </li>
